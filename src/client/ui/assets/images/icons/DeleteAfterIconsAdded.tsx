 ...
 * @param props.color1    A string representing the color to be applied.
 * @param props.height    A number or string representing the height of the DeleteAfterIconsAddedIcon element.
 * @param props.ref       A React ref object that can be attached to the SVG element for direct DOM access.
 ...
 * ```
 */
export const DeleteAfterIconsAdded = ({
    className = '',
    color1 = '#212325',
    height = 360.65,
    ref,
    testId = 'DeleteAfterIconsAdded',
    width = 383.55
}: DeleteAfterIconsAddedProps) => (
    <svg
        ref={ref}
        className={className}
        data-cy={testId}
